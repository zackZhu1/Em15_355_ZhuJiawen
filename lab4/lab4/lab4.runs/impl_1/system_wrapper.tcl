...
set rc [catch {
  ...
  add_files -quiet D:/lab4/lab4.runs/synth_1/system_wrapper.dcp
  add_files D:/lab4/lab4.srcs/sources_1/bd/system/system.bmm
  set_property SCOPED_TO_REF system [get_files -all D:/lab4/lab4.srcs/sources_1/bd/system/system.bmm]
  set_property SCOPED_TO_CELLS {} [get_files -all D:/lab4/lab4.srcs/sources_1/bd/system/system.bmm]
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache {d:/lab4/lab4.cache} }
  opt_design 
...
set rc [catch {
  ...
  if { [file exists D:/lab4/lab4.runs/synth_1/system_wrapper.hwdef] } {
    catch { write_sysdef -hwdef D:/lab4/lab4.runs/synth_1/system_wrapper.hwdef -bitfile system_wrapper.bit -meminfo system_wrapper_bd.bmm -file system_wrapper.sysdef }
  }
